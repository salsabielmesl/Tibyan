                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <div class="container">
                                <div class="row justify-content-end mb-4">
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#addContactModal">
                            ...
                            <div class="table-card-wrapper">
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered align-middle table-striped m-0" id="datatable">
                                        ...
                                        <tbody>
                                                <tr>
                                                    <td>fa fa-map-marker-alt text-primary</td>
                                                    <td>Address</td>
                                                    <td>Beirut Arab University, Debbiyeh</td>
                                                    <td>
                                                        <a href="contact_update_form.php" class="btn btn-success btn-action text-white">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a href="contact_delete.php" class="btn btn-danger btn-action text-white">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>fa fa-phone-alt text-primary</td>
                                                    <td>Call Us Now</td>
                                                    <td>+961 7 985858</td>
                                                    <td>
                                                        <a href="contact_update_form.php" class="btn btn-success btn-action text-white">
                                                ...
                                                <tr>
                                                    <td>fa fa-envelope-open text-primary</td>
                                                    <td>Mail Us Now</td>
                                                    <td>tebyan@gmail.com</td>
                                                    <td>
                                                        <a href="contact_update_form.php" class="btn btn-success btn-action text-white">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
