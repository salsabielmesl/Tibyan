                ...
                <div class="row min-vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-8 col-lg-6 py-5">
                        ...
                        <div class="form-card-wrapper">
                            <h4 class="mb-4 text-dark font-weight-bold text-start">Update Services Settings</h4>
                            
                            <form action="update_services.php" method="POST" enctype="multipart/form-data">
                                <input type="text" name="services_id" id="services_id" class="form-control" hidden value="">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="text1" id="text1" class="form-control" placeholder="text1">
                                </div>
