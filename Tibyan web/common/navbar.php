<?php if (session_status() === PHP_SESSION_NONE) session_start(); ?>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <?php if (empty($_SESSION['logged_in'])): ?>
            <a href="signin.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">
                Enter lab tests<i class="fa fa-arrow-right ms-3"></i>
            </a>
            <?php else: ?>
            <a href="labtests.php" class="btn btn-primary rounded-0 py-4 px-lg-5 d-none d-lg-block">
                Enter lab tests<i class="fa fa-arrow-right ms-3"></i>
            </a>
            <?php endif; ?>
        </div>
